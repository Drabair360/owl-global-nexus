...
const dict: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    'home.milestones.2024': 'Premier exercice clos. Résultat net à deux chiffres en pourcentage. Comptes déposés au greffe.',
    'home.milestones.2026a': 'Structuration du groupe en deux pôles ; immatriculation de CAO Industries au RCS de Marseille, le 5 août 2026.',
    ...
    'home.milestones.2026d': 'Immatriculation de Line Builder au RCS de Paris, le 17 août 2026.',
    'home.milestones.next':
      'À venir - constitution des entités restantes du groupe ; premiers déploiements après l’Afrique de l’Ouest : en Afrique de l’Est et dans le Sud de la France.',
    ...
    'journal.2026a.body': 'Structuration du groupe en deux pôles ; préparation des sociétés du pôle opérationnel.',
    'journal.2026d.date': '5 août 2026',
    'journal.2026d.title': 'Immatriculation de CAO Industries',
    'journal.2026d.body': 'CAO Industries, société par actions simplifiée présidée par Owl International, est immatriculée au registre du commerce et des sociétés de Marseille.',
    'journal.2026e.date': '17 août 2026',
    'journal.2026e.title': 'Immatriculation de Line Builder',
    'journal.2026e.body': 'Line Builder, société par actions simplifiée présidée par Owl International, est immatriculée au registre du commerce et des sociétés de Paris.',
    'journal.2023.date': '23 août 2023',
    ...
    'journal.2024.body': 'Premier exercice clos. Résultat net à deux chiffres en pourcentage. Comptes déposés au greffe.',
    'journal.index': 'Index par année',
    'journal.entry': 'entrée',
    'journal.entries': 'entrées',
    'notice.title': 'Notice',
    'notice.pole': 'Pôle',
    'notice.status': 'Statut',
    'notice.scope': 'Périmètre',
    'notice.incorporation': 'Constitution',
    'notice.registration': 'Immatriculation',
    'notice.rank': 'Rang éditorial',
    'kpi.title': 'Le groupe en cinq faits',
    'kpi.poles': 'pôles complémentaires',
    'kpi.companies': 'sociétés du groupe',
    'kpi.continents': "continents d'opération",
    'kpi.rcs': 'immatriculation RCS Paris',
    'kpi.pages': 'pages publiées',
    'kpi.source.orga': 'organigramme',
    ...
    'privacy.tracking.body':
      'Owl International n’installe aucun cookie publicitaire, aucun pixel de reciblage et n’exploite aucun outil d’analyse d’audience à des fins marketing. La plateforme d’hébergement du site (Lovable Labs AB) dépose toutefois, pour son propre compte, des cookies strictement techniques et de mesure d’audience de l’infrastructure : « __dpl » (identification du déploiement servi, durée de la session), « __cf_bm » (protection anti-robots du réseau de diffusion, environ 30 minutes) et, selon les requêtes, « session-id » (identifiant de session anonyme, durée de la session). Ces cookies alimentent une mesure d’audience agrégée de l’hébergeur ; ils ne sont recoupés avec aucune autre donnée, ne servent ni au profilage ni à la publicité, et ne sont pas utilisés par Owl International pour identifier un visiteur. Vous pouvez les bloquer ou les effacer depuis les réglages de votre navigateur, sans altérer le fonctionnement du site.',
  ...
  en: {
    ...
    'home.milestones.2024': 'First financial year closed. Double digit % net income. Accounts filed with the commercial court registry.',
    'home.milestones.2026a': 'Structuring of the group into two divisions; registration of CAO Industries at the Marseille Commercial Register, on 5 August 2026.',
    ...
    'home.milestones.2026d': 'Registration of Line Builder at the Paris Commercial Register, on 17 August 2026.',
    'home.milestones.next':
      'Upcoming - incorporation of the group’s remaining entities; first deployments beyond West Africa: East Africa and the South of France.',
    ...
    'journal.2026a.body': 'Structuring of the group into two divisions; preparation of the operational companies.',
    'journal.2026d.date': '5 August 2026',
    'journal.2026d.title': 'Registration of CAO Industries',
    'journal.2026d.body': 'CAO Industries, a simplified joint-stock company chaired by Owl International, is registered at the Marseille Commercial Register.',
    'journal.2026e.date': '17 August 2026',
    'journal.2026e.title': 'Registration of Line Builder',
    'journal.2026e.body': 'Line Builder, a simplified joint-stock company chaired by Owl International, is registered at the Paris Commercial Register.',
    'journal.2023.date': '23 August 2023',
    'journal.2026a.date': '27 July 2026',
    'journal.2026b.date': '2026',
    'journal.2026c.date': '13 July 2026',
    'journal.2024.date': '2024',
    'journal.2024.title': 'First financial year',
    'journal.2024.body': 'First financial year closed. Double digit % net income. Accounts filed with the commercial court registry.',
    'journal.index': 'Index by year',
    'journal.entry': 'entry',
    'journal.entries': 'entries',
    'notice.title': 'Record',
    'notice.pole': 'Division',
    'notice.status': 'Status',
    'notice.scope': 'Scope',
    'notice.incorporation': 'Incorporation',
    'notice.registration': 'Registration',
    'notice.rank': 'Editorial rank',
    'kpi.title': 'The group in five facts',
    'kpi.poles': 'complementary divisions',
    'kpi.companies': 'companies in the group',
    'kpi.continents': 'continents of operation',
    'kpi.rcs': 'Paris Commercial Register filing',
    'kpi.pages': 'published pages',
    'kpi.source.orga': 'group chart',
    ...
    'privacy.tracking.body':
      'Owl International sets no advertising cookie, no retargeting pixel and operates no audience analytics tool for marketing purposes. The site’s hosting platform (Lovable Labs AB) does however set, on its own behalf, strictly technical infrastructure-measurement cookies: “__dpl” (identifies the deployment being served, session duration), “__cf_bm” (delivery-network bot protection, about 30 minutes) and, depending on the request, “session-id” (anonymous session identifier, session duration). These cookies feed the host’s aggregated infrastructure audience measurement; they are not cross-referenced with any other data, are not used for profiling or advertising, and are not used by Owl International to identify a visitor. You may block or delete them from your browser settings without affecting how the site works.',
