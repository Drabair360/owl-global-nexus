...
const dict: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    'journal.2026a.body': 'Structuration du groupe en deux pôles ; constitution de CAO Industries engagée, capital déposé.',
  ...
  en: {
    ...
    'journal.2026a.body': 'Structuring of the group into two divisions; incorporation of CAO Industries under way, capital deposited.',
