...
/* Le bloc 2026 suit les dates connues, du 13 juillet au 17 août. */
const entries: Entry[] = [
  ...
  { year: '2026', dateKey: 'journal.2026d.date', tKey: 'journal.2026d.title', bKey: 'journal.2026d.body' },
  { year: '2026', dateKey: 'journal.2026e.date', tKey: 'journal.2026e.title', bKey: 'journal.2026e.body' },
