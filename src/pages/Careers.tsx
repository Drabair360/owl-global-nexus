  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-orange-100">
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-rose-900 via-pink-900 to-orange-900 overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-full h-48 bg-gradient-to-b from-transparent to-orange-900/80" />
      ...
      {/* Seamless Transition */}
      <div className="relative h-48 bg-gradient-to-b from-orange-900/80 via-orange-600 via-orange-300 to-white overflow-hidden">
