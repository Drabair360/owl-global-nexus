    ...
    <div className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-2xl p-6 shadow-2xl overflow-hidden">
      ...
      <div className="relative w-full h-96 rounded-xl overflow-hidden bg-gradient-to-b from-sky-200 to-blue-300 shadow-inner">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-blue-900/20 to-blue-900/30" />
          ...
          {locationGroups.map((group, index) => (
            ...
            >
              ...
              <div className="relative w-12 h-12 bg-gradient-to-br from-blue-500 via-purple-600 to-pink-500 rounded-full flex items-center justify-center shadow-xl hover:scale-125 transition-all duration-300 border-4 border-white ring-4 ring-blue-200/50">
                <div className="w-4 h-4 bg-white rounded-full shadow-inner" />
              </div>
              
              {/* Enhanced Job Count Badge */}
              <div className="absolute -top-3 -right-3 w-8 h-8 bg-gradient-to-r from-red-500 to-pink-600 rounded-full flex items-center justify-center text-white text-sm font-bold border-3 border-white shadow-lg">
                {group.jobs.length}
              </div>
              
              {/* Location Label */}
              <div className="absolute top-14 left-1/2 transform -translate-x-1/2 bg-white/95 backdrop-blur-sm px-3 py-1 rounded-lg text-xs font-medium text-gray-800 shadow-lg opacity-0 hover:opacity-100 transition-opacity duration-300 whitespace-nowrap border border-gray-200">
        ...
        {/* Map Loading State */}
        {!mapLoaded && (
          <div className="absolute inset-0 flex items-center justify-center bg-sky-200/80">
            <div className="text-gray-600 font-medium">Loading world map...</div>
          </div>
        )}
      </div>
      ...
      <div className="mt-6 flex flex-wrap gap-6 text-sm">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 border-3 border-white shadow-md" />
          <span className="text-gray-700 font-medium">Job Locations ({jobs.length} total positions)</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded-full bg-gradient-to-r from-red-500 to-pink-600 border-3 border-white shadow-md flex items-center justify-center text-white text-xs font-bold">
            #
          </div>
