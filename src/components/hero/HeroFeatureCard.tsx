...
const HeroFeatureCard = ({ icon: Icon, title, description }: HeroFeatureCardProps) => {
  return (
    <div className="bg-white/90 rounded-xl p-8 border border-white/30 hover:bg-white/95 transition-all duration-300 group hover-institutional hover:shadow-[0_10px_40px_rgba(251,146,60,0.3)]">
