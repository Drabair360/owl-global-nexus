...
import { ExternalLink, Factory, Cpu, Sparkles, MapPin } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          ...
          <Card className="group hover:shadow-2xl transition-all duration-300 border-2 hover:border-primary/50 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20">
            <CardHeader className="pb-4">
              ...
              <CardTitle className="text-2xl font-bold">CAOAGRO.COM</CardTitle>
          ...
          <Card className="group hover:shadow-2xl transition-all duration-300 border-2 hover:border-primary/50 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20">
            <CardHeader className="pb-4">
              ...
              <CardTitle className="text-2xl font-bold">AKOULA Platform</CardTitle>
              <CardDescription className="text-lg">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 gap-3">
                <div className="bg-white/50 dark:bg-slate-800/50 p-3 rounded-lg">
                  <h4 className="font-semibold text-sm">Agro-Industry Suite</h4>
                  <p className="text-xs text-muted-foreground">Industrial Quote Builder, Equipment Marketplace, Training Platform</p>
                </div>
                <div className="bg-white/50 dark:bg-slate-800/50 p-3 rounded-lg">
                  <h4 className="font-semibold text-sm">KIDZ LAB Entertainment</h4>
                  <p className="text-xs text-muted-foreground">AI-powered talent discovery and booking platform</p>
                </div>
              </div>
        ...
        <div className="text-center">
          ...
          <div className="inline-flex items-center px-4 py-2 bg-muted rounded-full">
            ...
            <span className="text-sm font-medium">47 Boulevard de Courcelles, 75008 Paris, France</span>
          </div>
        </div>
      </div>
    </section>
